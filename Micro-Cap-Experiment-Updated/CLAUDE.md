...
- **Complete**: **Week 53 research (final week) — CXW buy WITHDRAWN.** CoreCivic operates prisons/ICE detention, a prohibited business; it passed every quantitative filter and was recommended because the exclusion was never written down. **No replacement** — nothing else passed; cash held. Prohibited list now enforced: `portfolio_rules.md` Exclusions (prisons/detention, weapons/defence/firearms, predatory lending, Israeli-affiliated), a **first-step check at the PRV gate**, and `screener.py` hard-excludes Aerospace & Defense plus a ticker blocklist. The pre-existing defence and Israeli exclusions had never been enforced in code either
- **In progress**: **3 positions** (ATRC +59.0%, PAR −5.5%, VTS +5.1%), equity **$733.51**, cash **$259.33 (35.4%)**, **gap −4.56%**, TWR alpha +0.55%, regime RISK-OFF. Only open order: **conditional ATRC partial — sell 1 if it closes ≥$54.88**
- **Next**: **5 sessions to 2026-09-18.** VTS ex-dividend **Tue 9/15** (~$0.44, paid 9/30, no ledger credit). Security & Protection Services and Credit Services candidates need a manual prohibited-business check. Israeli affiliation is checked per name, never by industry. Realistic finish: behind the benchmark
