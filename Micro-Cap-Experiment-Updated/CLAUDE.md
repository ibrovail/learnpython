...
- **Complete**: **Week 53 research (final week)** — 9/14 pre-market, Aggressive but 0–1 names. **BUY 5 CXW, limit $34.93, stop $32.85/$32.70** (Industrials; revenue +24.3%, all 5 analysts Buy with lowest target +14.5%, active $500M ASR = 14.5% of market cap, beta 0.60). Detention-policy driver verified: every negative item (ICE warehouses, 5,500-bed cut, 16%/11% selloff) **dated to Feb 2026** and followed by new highs. **Conditional: sell 1 ATRC if it closes ≥$54.88.** Three in-session corrections: VTS ex-div is **Tue 9/15** (yfinance said 9/14), CXW forward PE 2.11 is a misentry (~20.8×), and a search summary mis-dated the selloff as August
- **In progress**: 3 → **4 positions** (ATRC +59.0%, PAR −5.5%, VTS +5.1%, CXW new), equity **$733.51**, cash $259.33 → **$84.68 (11.5%)**, **gap −4.56%**, TWR alpha +0.55%, regime RISK-OFF. Rejected BRBS (revenue −13.2%), NMAX (lossmaking, fwd PE 111), LFST (+9.5% upside at high), BZH/UTZ/DV (deal-pinned, ~0.3% ATR)
- **Next**: **5 sessions to 2026-09-18.** VTS ex-dividend **Tuesday** (~$0.44 drop, paid 9/30 — no ledger credit). Watch ATRC's close vs $54.88. **CXW's bear case is an ICE insourcing headline** (DRI deadline 9/30; Feb precedent −10.3% in a day) — reassess same day, don't leave it to the stop. Realistic finish: behind the benchmark
