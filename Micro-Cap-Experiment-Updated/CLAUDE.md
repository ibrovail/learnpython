...
- **Complete**: **Week 52 research (final window)** — 9/07, Aggressive posture. **BUY VTS 6 sh, limit $17.85, stop $16.65/$16.50** (Energy, empty sector; revenue +7.9%, Buy PT $21.00 +18.1%, beta 0.63, ATR just 2.33%). Oil driver verified **rising**: WTI $92.45, +7.8% 5d / +12.6% 20d. **Declined TYRA** despite it being the only name with a dated catalyst in the window (SURF302 Phase 2 data 9/09, Strong Buy PT +77%) — a stop cannot protect an oncology gap, the +15.25% Friday move prices the anticipation, and there is no edge on the readout; order written out in §5 if the user overrides
- **In progress**: **3 positions → 4 after VTS** (ATRC +50.2%, PAR +3.8%, CADL +11.8%), equity **$772.00**, cash $272.17 → **$165.07 (21.4%)** post-trade, **gap −0.35%**, TWR alpha +5.71%. Only one of two authorised slots used — NAVI (revenue −42.8%), DAN (forward PE above trailing), GNW (no coverage) and ITGR (PT below price) all failed on their own numbers
- **Next**: **9 sessions to 2026-09-18**, no further research window. Execute VTS Tuesday. **ATRC +60% partial trigger $54.88 (6.5% away)** — lean is to take it, not defer a third time, since BoxX-NoAF data is H1 2027. **VTS ex-dividend Sept 15** drops the price ~$0.44 with no ledger credit — do not misread as a thesis break. CADL's restoration allowance remains unused. Endgame: hold through the close
