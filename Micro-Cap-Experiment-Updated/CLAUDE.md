...
- **Complete**: **Screener Phase 3 live** — `composite_score` = equal-weighted ranks of `low_vol`, `near_high`, `squeeze`, `vol_5_50`, `vol_ratio`, `vs_sma50` (the six Phase 2 winners); **20-day momentum no longer scored**; `composite_legacy` and `composite_dedup` saved with every screen for the Phase 4 out-of-sample test. Verified 9/15: 1,190 evaluated → 807 survivors → 50 listed, new score 0.85 rank-correlated with the old, 27/50 overlap. Phase 2 study and its pre-registration: `Experiment Details/Screener Factor Study — Phase 2.md`
- **In progress**: **Daily 9/15 — PAR stopped out at $17.05** (−$22.00, −10.5%; sector selloff: TOST −4.4%, LSPD −2.8%, no PAR-specific news or filing). Two positions left — ATRC +63.9%, VTS +3.8% — equity **$726.72**, cash **$446.88 (61.5%)**, **gap +0.01%**, regime RISK-OFF (IWM 3.61% below its 50-day). Awaiting broker placement: **VTS stop → $17.77 / $17.62**; **ATRC $51.50 / $51.35** if not already live
- **Next**: Week 54 weekend research deploys ~$338 of idle cash (RISK-OFF → catalyst-driven only). PAR re-entry banned through 9/29; VTS dividend ~$2.23 lands 9/30 with no ledger entry path. **Open question for the user**: `portfolio_rules.md` still defines momentum/technical plays by momentum, which Phase 2 found has no ranking skill. Pending: final 52-week readout (reconcile S&P +14.87% vs +14.59%)
