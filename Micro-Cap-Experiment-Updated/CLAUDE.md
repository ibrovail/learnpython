...
- **Complete**: Daily 9/03 — **TILE stopped out at $36.24 (+12.9%)**, breaching its $36.25 trigger by 4c and closing back above at $36.39. Two standing stop rules now in `portfolio_rules.md`: **anti-ratchet** (no raise under 0.5×ATR, must leave ≥1.5×ATR) and **mechanical once-per-position restoration**; conviction-gated lowering was proposed and **rejected** (conviction peaks on losers — WWW's PT upside *widened* +16%→+23% as it fell). Both of today's candidate raises were correctly blocked — first live test of the rule
- **In progress**: **3 positions** (PAR/ATRC/CADL), equity **$767.15**, cash **$272.17 (35.5%)**, **gap −1.35%**, TWR alpha +4.51%. ATRC +52.9% (stop $48.50 locks +41.4%); +60% partial trigger $54.88 is 4.4% away. CADL is *eligible* for restoration (0.71×ATR) — declined, allowance preserved, since its BLA catalyst is Q4 2026, outside the runway
- **Next**: 10 sessions. **The constraint has inverted**: deployable cash is now **$210.80** and the gap needs only **+3.85% from cash** (vs an impossible +27.5% in Week 51), so deployment is the highest-leverage decision left. Today proved the cost — SPY +1.05%, book flat, gap +0.15% → −1.35% in one session. **Run Week 52 research after Friday's close**; room for 3 more positions
